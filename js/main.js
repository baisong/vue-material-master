...
var KWM = {
	data: {
		...
		// ! = '-american'
		ethnicities: [
			{name: 'so', words: ['somali*~!', 'somalia~!', 'somalian!', 'somaliland!']},
			{name: 'ke', words: ['kenya~!', 'kenyan!']},
			{name: 'sw', words: ['swahili*!', 'uganda~!', 'ugandan!']},
			{name: 'mu', words: ['muslim!', 'ummah', 'black muslim!', 'african muslim!', 'somali muslim!']},
			{name: 'ar', words: ['arabic*!', 'arab!', 'arabian!']},
			{name: 'me', words: ['amemsa!', 'middle eastern~!', 'middle-eastern~!']},
			{name: 'ps', words: ['palestine~!', 'palestinian~!']},
			{name: 'sy', words: ['syria~!', 'syrian~!', 'syrian crisis', 'syria crisis']},
			{name: 'af', words: ['africa~!', 'african!', 'black!']},
			{name: 'as', words: ['asia~', 'asian~!']},
			{name: 'jw', words: ['jewish~!', 'israel~', 'israeli~!', 'jew', 'hebrew*']},
			{name: 'vt', words: ['vietnam~', 'vietnamese*~!']},
			{name: 'bm', words: ['burma~', 'myanmar~', 'burmese*~!', 'karen*!', 'karenni*', 'karen-burmese', 'karen burmese', 'thai*~!', 'thailand~']},
			{name: 'fg', words: ['afghanistan~!', 'afghan~!', 'afghani~!', 'dari*']},
			{name: 'ir', words: ['iraq~', 'iraqi~!']},
			{name: 'ch', words: ['chaldean!', 'chaldean-iraqi~', 'iraqi-chaldean', 'christian iraqi', 'iraqi christian']},
			{name: 'co', words: ['congo', 'congolese!', 'drc']},
			{name: 'su', words: ['sudan~', 'sudanese~!', 'south sudan~', 'south sudanese~!']},
			{name: 'ba', words: ['bantu*', 'somali bantu*', 'kizigula', 'zigula']},
			{name: 'ea', words: ['east african', 'east africa', 'horn of africa']},
			{name: 'et', words: ['ethiopia~!', 'ethiopian*~!']},
			{name: 'dj', words: ['djibouti~!', 'djiboutian~!']},
			{name: 'bh', words: ['bhutan~', 'bhutanese~', 'hmong*~']},
			{name: 'ir', words: ['iran~', 'irani!', 'iranian~!', 'farsi*']},
			{name: 'er', words: ['eritrea~', 'eritrean*~!']},
			{name: 'am', words: ['amharic*', 'oromo*', 'tigrinya*']},
			{name: 'uz', words: ['uzbeki*~!', 'uzbek~!', 'uzbekistan~']},
			{name: 'gl', words: ['global', 'international', 'crisis', 'world', 'humanitarian']},
