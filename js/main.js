...
var KWM = {
	data: {
		...
		ethnicities: [
			...
			{name: 'bm', words: ['black muslim!', 'african muslim!', 'somali muslim!']},
			...
			{name: 'ba', words: ['bantu*', 'somali bantu*', 'zigula']},
			...
			{name: 'ir', words: ['iran~', 'irani!', 'iranian~!'], places: ['iran']},
			...
			{name: 'in', words: ['intersectional', 'feminist']},
			{name: 'is', words: ['islamophobia', 'anti-islamophobia']},
			{name: 'rw', words: ['refugeeswelcome', 'refugees welcome']},
			{name: 'an', words: ['anti-trump', 'anti trump']},
			{name: 're', words: ['resist', 'resistance']},
